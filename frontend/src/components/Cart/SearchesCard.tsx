...
import { SearchCardTargets } from '../../common/reactJoyrideSteps';
...
const SearchesCard: React.FC<Props> = ({
  ...
  return (
    <Col key={uuid} xs={20} sm={16} md={12} lg={10} xl={8}>
      <Card
        ...
        actions={[
          <ToolTip title="Apply search query and view results" trigger="hover">
            <SearchOutlined
              className={SearchCardTargets.applySearchesBtn}
          ...
          <ToolTip title="View results in JSON format">
            <a
              className={SearchCardTargets.jsonBtn}
          ...
          <ToolTip title="Remove search query from library">
            <DeleteOutlined
              className={SearchCardTargets.removeSearchBtn}
      ...
      >
        {numResults}
        <p className={SearchCardTargets.projectDescription}>
